"""
Django settings for asacademy project.
...
SECRET_KEY = 'django-insecure-hty^(_jtx0q-&g3r^dd$wwo25behj$yq8bhn&qc%x+15y703s#'
...
WSGI_APPLICATION = 'asacademy.wsgi.application'
